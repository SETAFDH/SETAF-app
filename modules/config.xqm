...
(:~~
 ...
 :)
declare variable $config:webcomponents :="2.25.5";
...
(:
 ...
 :)
declare variable $config:default-template :="corpus.html";
...
declare variable $config:facets := [
    ...
    map {
        "dimension": "false-place",
        "heading": "facets.other-places",
        "max": (),
        "hierarchical": false()
    },
    map {
...
declare variable $config:data-exclude :=
    ...
    doc($config:data-root || "/edition-critique/edCrit_v1.xml")//tei:text,
...
(:~
 ...
 :)
declare variable $config:default-odd :="setaf.odd";
...
(:~
 ...
 :)
declare variable $config:odd-available :=("setaf.odd");
...
declare function config:collection-config($collection as xs:string?, $docUri as xs:string?) {
    ...
    switch ($collection)
        case "edition-critique" return
            map {
                "odd": "setaf.odd",
                "view": "page",
                "depth": $config:pagination-depth,
                "fill": $config:pagination-fill,
                "template": "ed-critique.html"
            }
        case "gravures" return
            map {
                "odd": "setaf.odd",
                "view": "body",
                "depth": $config:pagination-depth,
                "fill": $config:pagination-fill,
                "template": "gravures.html"
            }
        case "static" return
            map {
                "odd": "setaf.odd",
